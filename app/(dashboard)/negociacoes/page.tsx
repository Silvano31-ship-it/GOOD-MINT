...
import { LoseNegotiation } from "@/components/negociacoes/LoseNegotiation";
                      ...
                      <div className="flex items-center gap-2">
                        {n.status === "aberta" ? (
                          <>
                            ...
                            <LoseNegotiation negotiationId={n.id} />
                          </>
                        ) : (
                          <span className="text-xs text-gm-700/40">
                            {n.status === "perdida" ? "Perdida" : "Fechada"} em {formatDate(n.closed_at)}
                          </span>
                        )}
