...
// inicia o acompanhamento de pós-venda (regra da seção 3 da spec). Sem e-mail
// do lead, o Pós-Venda não consegue mandar os avisos automáticos nem liberar
// o Portal do Cliente — por isso a opção fica bloqueada até o corretor
// cadastrar um e-mail pro lead.
"use client";
...
export function CloseNegotiation({
  ...
  const [startPostSale, setStartPostSale] = useState(leadHasEmail);
          ...
          <div className="w-full max-w-sm rounded-2xl bg-white p-6 shadow-2xl" onClick={(e) => e.stopPropagation()}>
            ...
            {leadHasEmail ? (
              ...
              <div className="mt-4 rounded-lg border border-amber-200 bg-amber-50 p-3 text-sm text-amber-800">
                Este lead não tem <b>e-mail</b> cadastrado — sem ele, o Pós-Venda não consegue enviar os avisos automáticos nem liberar o Portal do Cliente.{" "}
                <Link href={`/leads/${leadId}`} className="font-semibold underline">Adicionar e-mail ao lead</Link> antes de iniciar o Pós-Venda.
              </div>
            )}
